#ifndef DUSK_TOUCH_CONTROLS_LAYOUT_H
#define DUSK_TOUCH_CONTROLS_LAYOUT_H
...
constexpr ControlRect resolve_anchored_rect(ControlAnchor anchor, float x, float y, float w,
    float h, ControlLayoutSize docSize) noexcept {
    switch (anchor) {
...
constexpr ControlProps encode_control_props(
    ControlRect visual, ControlLayoutSize docSize, ControlProps props, ControlAnchor anchor) noexcept {
    props.anchor = anchor;
...
#endif  // DUSK_TOUCH_CONTROLS_LAYOUT_H
