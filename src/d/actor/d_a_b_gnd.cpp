...
#if TARGET_PC
        for (int r = 0; r < b_gnd_class::REIN_STRAND_COUNT; r++) {
            i_this->mReinsInterp[r].writeback(i_this->mHorseReins[r].getPos(0), b_gnd_class::REIN_SEGMENT_COUNT);
        }
        i_this->mReinsTexInterp.writeback(i_this->field_0x21e8.getPos(0), b_gnd_class::REIN_TEX_COUNT);
#endif
    }
