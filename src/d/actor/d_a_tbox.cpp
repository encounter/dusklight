...
int daTbox_c::setGetDemoItem() {
    ...
    item_no = dusk::mods::item_check_tagged(giveTag, mVanillaItemNo, this);
#endif
...
#if TARGET_PC
        mVanillaItemNo = (home.angle.z >> 8) & 0xFF;
        const u8 resolvedItem = dusk::mods::item_check_chest(getTboxNo(), mVanillaItemNo, this);
