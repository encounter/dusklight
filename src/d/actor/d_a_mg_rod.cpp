...
#if TARGET_PC
        i_this->mLineInterp.writeback(i_this->linemat.getPos(0), MG_ROD_LURE_LINE_LEN, &dmg_rod_interp_post, i_this);
#endif
...
#if TARGET_PC
        i_this->mLineInterp.writeback(i_this->linemat.getPos(0), MG_ROD_UKI_LINE_LEN, &dmg_rod_interp_post, i_this);
#endif
