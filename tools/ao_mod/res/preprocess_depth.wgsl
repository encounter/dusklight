...
// entry point (downsample_mip4): the core WebGPU limit is 4 storage textures per stage, one
// short of Bevy's 5 (it raises the device limit; the host device is not ours to configure).
